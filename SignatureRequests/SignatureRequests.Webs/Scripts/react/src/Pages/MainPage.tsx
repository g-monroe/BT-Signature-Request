                   ...
                   <Layout.Content>
                        {
                                ...
                                ALL_ROUTES.map((route,i) => {
                                    ...
                                    render={(props:any)=><UserProvider value = {{user:this.state.user, formId: props.match.params.id, requestId: props.match.params.requestid, FormId: props.match.params.FormId,update:this.updateUser}}><WwithUser></WwithUser></UserProvider>}
