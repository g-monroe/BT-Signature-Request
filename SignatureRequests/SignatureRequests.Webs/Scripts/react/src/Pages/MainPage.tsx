                   ...
                   <Layout.Content>
                        {
                                ...
                                ALL_ROUTES.map((route,i) => {
                                    ...
                                    render={(props:any)=><UserProvider value = {{user:this.state.user, groupId: props.match.params.groupId , formId: props.match.params.id, requestId: props.match.params.requestid, update:this.updateUser}}><WwithUser></WwithUser></UserProvider>}
