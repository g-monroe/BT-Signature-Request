...
import CopyView from './Requester/FormView/CopyView';
...
export {Login, SignUp, Create, DashBoard, Send, View, AddSignatures, SignDocument, Error, Edit, FormView, CopyView}
